...
public class OTJunction {
	...
	private String otConfirm;

	public OTJunction() {}

	public OTJunction(int id, int workScheduleId, int otTypeId, Time otCheckInTime, Time otCheckOutTime, String otConfirm) {
		this.id = id;
	...
	public String getOtConfirm() {
		return otConfirm;
	}
	public void setOtConfirm(String otConfirm) {
		this.otConfirm = otConfirm;
	}
